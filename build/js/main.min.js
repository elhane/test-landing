...
/* harmony import */ var _vendor_testInstruments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/testInstruments */ "./js/vendor/testInstruments.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // testInstruments();
  });
}); // ---------------------------------
...
/***/ "./js/vendor/testInstruments.js":
/*!**************************************!*\
  !*** ./js/vendor/testInstruments.js ***!
  \**************************************/
/*! exports provided: testInstruments */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testInstruments", function() { return testInstruments; });
...
var testInstruments = function testInstruments() {
    ...
    if (images.length !== 0) {
      ...
      images.forEach(function (image) {
        ...
        if (parent.nodeName == "PICTURE") {
          ...
          var children = _toConsumableArray(parent.childNodes).filter(onlySource); // проверяем детей на кадрирование. 
  ...
  var panelBoard = document.querySelector('.ts-panel');
  ...
  panelBoard.onclick = function (event) {
